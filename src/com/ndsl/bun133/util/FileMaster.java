...
public class FileMaster {
    ...
    static {
        addRepo("block","resources\\game\\textures\\blocks");
        addRepo("blocks","resources\\game\\textures\\blocks");
        addRepo("title","resources\\game\\textures\\title");
        addRepo("textures","resources\\game\\textures");
        addRepo("game","resources\\game");
    }
}
